...
public class ShiroRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
        ...
        return new SimpleAuthenticationInfo(userInfo, userInfo.getPassWord(), ByteSource.Util.bytes(salt), getName());
    }

    @Override
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principalCollection) {
        SimpleAuthorizationInfo authorizationInfo = new SimpleAuthorizationInfo();
        SysOperator userInfo = (SysOperator) principalCollection.getPrimaryPrincipal();
    ...
    protected String getAuthorizationCacheKey(PrincipalCollection principals) {
        SysOperator userInfo = (SysOperator)  principals.getPrimaryPrincipal();
